...
class TestFetchAggvaultValidation:
    ...
    def test_invalid_timeframe_raises(self):
        with pytest.raises(ValueError, match="Invalid timeframe.*4h"):
            fetch_aggvault("EURUSD", "4h", "2021-04-01", "2026-03-31", api_key="tk_x")
    ...
    def test_same_start_end_raises(self):
        with pytest.raises(ValueError, match="start.*must be before end"):
            fetch_aggvault("EURUSD", "1h", "2021-04-01", "2021-04-01", api_key="tk_x")
